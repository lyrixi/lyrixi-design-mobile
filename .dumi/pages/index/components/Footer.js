  ...
  const footerGroups = [
    {
      ...
      items: [
        {
          title: 'GitHub',
          link: 'https://github.com/colaboy/lyrixi-design-mobile'
        },
        {
          title: trans('Releases', '发布日志'),
          link: 'https://github.com/colaboy/lyrixi-design-mobile/releases'
        },
        {
          title: trans('Questions And Feedback', '提问与反馈'),
          link: 'https://github.com/colaboy/lyrixi-design-mobile/issues/new/choose'
        }
      ]
    },
    {
