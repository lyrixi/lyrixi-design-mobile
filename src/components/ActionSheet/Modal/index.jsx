...
/* 测试使用-start
import { DOMUtil, LocaleUtil, Modal } from 'lyrixi-design-mobile'
测试使用-end */
  ...
  (
    ...
    function getCancelNode() {
      ...
      return (
        ...
        >
          {cancel || LocaleUtil.locale('取消', 'SeedsUI_cancel')}
        </div>
      )
    }
    return (
      <Modal
        ...
        {...props}
        animation="slideUp"
        modalClassName={DOMUtil.classNames('actionsheet-modal', modalClassName)}
      ...
      >
        ...
        <div style={groupStyle} className={DOMUtil.classNames('actionsheet-main', groupClassName)}>
          {list &&
            list.map((item, index) => {
