...
const Group = forwardRef(
  (
          ...
          <Fragment key={index}>
              ...
              className={DOMUtil.classNames(
                description
                  ? descriptionPosition === 'top'
                    ? 'tabbar-group-tab-description top'
                    : 'tabbar-group-tab-description bottom'
                  : '',
                'tabbar-group-tab-wrapper',
            ...
            >
              <div className="tabbar-group-tab">
                ...
                {name && <div className={`tabbar-group-tab-name`}>{name}</div>}
                {!name && placeholder ? (
    ...
    return (
      <div
        {...props}
        className={DOMUtil.classNames('tabbar-group', className)}
        disabled={disabled}
        ref={rootRef}
      >
        {getGroup()}
